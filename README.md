# Niko - Ultimate Discord Bot

**Niko** is a powerful, feature-rich Discord bot designed to enhance your server experience with comprehensive moderation tools, engaging economy systems, utility features, and much more. Built with modern Discord.js v14 and PostgreSQL for optimal performance and data persistence.
...
Niko offers a complete suite of tools for Discord server management and community engagement:
...
[**Niko Setup Tutorial**](https://www.youtube.com/@TouchDisc)

## Docker Deployment (Recommended)

Niko is fully containerized for easy deployment.
...
```bash
docker pull ghcr.io/omkarmodding13/niko:main
```
...
3. **Configure Environment Variables**
   ...
   - If your chosen `PORT` is already used, Niko automatically tries the next port(s)
...
Niko requires the following Discord intents:
- **Guilds**
- **Guild Messages**
- **Message Content**
- **Guild Members**
...
Niko is released under the MIT License. See [LICENSE](LICENSE) for details.

## Thank You

Thank you for choosing Niko for your Discord server! We're constantly working to improve and add new features based on community feedback.
