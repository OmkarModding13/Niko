...
const BANK_CAPACITY_PER_LEVEL = 50000;
...
/**
 * Calculate the maximum bank capacity.
 *
 * New system:
 * Base capacity = 100,000
 * Every bank upgrade = +50,000
 *
 * Level 0 = 100,000
 * Level 1 = 150,000
 * Level 2 = 200,000
...
export function getMaxBankCapacity(userData) {
    ...
    const bankLevel =
        Math.max(0, Number(userData.bankLevel || 0));

    return (
        BASE_BANK_CAPACITY +
        (bankLevel * BANK_CAPACITY_PER_LEVEL)
    );
}
...
export async function getEconomyData(client, guildId, userId) {
    try {
        ...
        logger.error(
            `Error getting economy data for user ${userId}`,
            error
        );
...
export async function setEconomyData(
    client,
    guildId,
    userId,
    data
    ...
    try {
        ...
        logger.error(
            `Error saving economy data for user ${userId}`,
            error
        );
    ...
    const outcomes = [
        {
            ...
            message:
                'You successfully robbed a bank and got away with {amount}!'
        },
        {
            success: true,
            amount:
        ...
        },
        {
            ...
            message:
                'The police caught you! You paid {fine} to get out of jail.'
        },
        {
            success: false,
            fine: 0,
            message:
                'Your attempt failed, but you managed to escape!'
        }
    ];
...
export function getRobOutcome(
    ...
    if (success) {
        ...
        return {
            ...
            amount,
            message:
                'You successfully robbed them and got away with {amount}!'
        };
        ...
        return {
            ...
            fine,
            message:
                'You got caught! You had to pay a fine of {fine}.'
        };
    }
}

export function formatShopItem(
    item,
    index
) {
    return (
...
export function getShopInventory() {
    return [
        ...
        },
        {
            ...
            price: 2000,
            description:
                'Work as a programmer for higher pay!',
            type: 'tool',
            workMultiplier: 1.5
        },
        {
            ...
            price: 5000,
            description:
                'Increases your bank capacity by 50,000!',
            type: 'upgrade',
            effect:
                'bank_capacity',
            value: 50000
