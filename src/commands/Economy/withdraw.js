...
export default {
    data: new SlashCommandBuilder()
        ...
        .addIntegerOption(option =>
            option
                .setName('amount')
                .setDescription('Amount of Souls to withdraw')
                .setRequired(true)
                .setMinValue(1)
        ),
    ...
    execute: withErrorHandling(async (interaction, config, client) => {
        ...
        const embed = successEmbed(
            ...
            `You successfully withdrew **${withdrawAmount.toLocaleString()} ${SOULS_EMOJI} Souls** from your bank.`
        )
            .addFields(
                {
                    name: `${SOULS_EMOJI} New Wallet Balance`,
                    value: `${userData.wallet.toLocaleString()} Souls`,
                    inline: true,
                },
                {
                    name: '🏦 New Bank Balance',
                    value: `${userData.bank.toLocaleString()} Souls`,
                    inline: true,
                },
            );
